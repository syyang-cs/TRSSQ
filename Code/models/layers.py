...
class SoftmaxAttention(nn.Module):
    ...
    def forward(self, premise_batch, premise_mask, hypothesis_batch, hypothesis_mask):
        ...
        prem_hyp_attn = masked_softmax(similarity_matrix, hypothesis_mask.squeeze(1))
...
def get_mask(sequences_batch, sequences_lengths):
    ...
    mask = torch.ones(batch_size, max_length, 2,dtype=torch.float)
    a=sequences_batch[:, :max_length]
    print(a)
